...
def main():
    ...
    code_mods: dict[module] = {'LA':LA,
                               'QR':QR,
                               'LS':LS}
    test_mods: dict[module] = {'test_LA':test_LA,
                               'test_QR':test_QR,
                               'test_LS':test_LS}
    ...
    for m_name, m_val in code_mods.items():
        ...
        t_mod: module = test_mods['test_' + m_name]
        # Build a dictionary of all functions in the current module
        m_fun: dict[function] = {obj:getattr(m_val, obj)
        ...
        for f_name, f_val in m_fun.items():
            ...
            shortdoc: string = f_val.__doc__[:f_val.__doc__.index('\n')]
            ...
            try:
                ...
                t_fun: function = getattr(t_mod, 'test_' + f_name)
